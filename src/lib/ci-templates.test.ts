...
describe('CI Templates', () => {
  describe('GitHub Actions', () => {
    it('should generate a valid GitHub Actions workflow', () => {
      ...
      expect(template).toContain('syntext build')
      expect(template).toContain('syntext deploy')
  ...
  describe('Dockerfile', () => {
    it('should generate a multi-stage Dockerfile', () => {
      ...
      expect(dockerfile).toContain('syntext build')
  ...
  describe('Docker Compose', () => {
    it('should generate a docker-compose config', () => {
      ...
      expect(compose).toContain('syntext dev')
